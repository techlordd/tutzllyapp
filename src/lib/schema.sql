...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  session_code_status VARCHAR(100),
  mothers_email TEXT,
  fathers_email TEXT,
  -- Missed session repeater fields (up to 3)
  missed_session_id1 VARCHAR(100),
  missed_schedule_id1 VARCHAR(100),
  missed_status1 VARCHAR(30),
  missed_tutor_id1 VARCHAR(100),
  missed_tutor_firstname1 VARCHAR(255),
  missed_tutor_lastname1 VARCHAR(255),
  missed_student_name1 VARCHAR(255),
  missed_course1 TEXT,
  missed_course_id1 INTEGER,
  missed_session_code_status1 VARCHAR(100),
  missed_session_id2 VARCHAR(100),
  missed_schedule_id2 VARCHAR(100),
  missed_status2 VARCHAR(30),
  missed_tutor_id2 VARCHAR(100),
  missed_tutor_firstname2 VARCHAR(255),
  missed_tutor_lastname2 VARCHAR(255),
  missed_student_name2 VARCHAR(255),
  missed_course2 TEXT,
  missed_course_id2 INTEGER,
  missed_session_code_status2 VARCHAR(100),
  user_id INTEGER REFERENCES users(id),
  entry_status VARCHAR(20) DEFAULT 'active',
  ip VARCHAR(45),
