...
export const COLUMN_MAPS: Record<string, Record<string, string>> = {
  ...
  sessions: {
    'SSID': 'ssid', 'Schedule ID (NEW)': 'schedule_id', 'Schedule ID': 'schedule_id', 'Tutor ID': 'tutor_id',
    'Tutor Name (pf79t) - First Name': 'tutor_firstname',
    'Tutor Name (pf79t) - Last Name': 'tutor_lastname',
    'Student ID': 'student_id', 'Student': 'student_name', 'Student Name': 'student_name', 'Student Email': 'student_email',
    'Course (NEW)': 'course_name', 'Course': 'course_name', 'Entry Date': 'entry_date', 'Day': 'day',
    'Schedule Start Time': 'schedule_start_time', 'Schedule Start Time (NEW)': 'schedule_start_time',
    'Schedule End Time': 'schedule_end_time', 'Schedule End Time (NEW)': 'schedule_end_time',
    'Schedule Day': 'schedule_day',
    'Zoom Link': 'zoom_link', 'Meeting ID': 'meeting_id', 'Meeting Passcode': 'meeting_passcode',
    'Hidden Start Session Time': 'start_session_time', 'Start Session Time': 'start_session_time',
    'Start Session Date': 'start_session_date',
    'End Session Date': 'end_session_date', 'End Session Time': 'end_session_time',
    'Session Duration': 'session_duration',
    'Reschedule To': 'reschedule_to', 'Reschedule To: (If Available)': 'reschedule_to',
    'Reschedule Time': 'reschedule_time', 'Reschedule Time: (If Available)': 'reschedule_time',
    'Status': 'status',
