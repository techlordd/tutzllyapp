...
export const COLUMN_MAPS: Record<string, Record<string, string>> = {
  ...
  grades: {
    ...
    'Tutor ID': 'tutor_id', 'Tutor Name': 'tutor_name',
    'Student Name': 'student_name', 'Student ID': 'student_id',
    'Course': 'course_name', 'Course ID': 'course_id_ref',
    ...
    'Status': 'status', 'Timestamp': 'timestamp', 'Last Updated': 'last_updated',
  ...
  messages_parent: {
    'Date': 'message_date', 'Time': 'message_time', 'Roles': 'role',
    'Sender Email': 'sender_email', 'User Role': 'user_role',
    ...
    'RECIPIENT ID (DEPRECATED)': 'recipient_id_deprecated',
    'RECIPIENT (DEPRECATED)': 'recipient_deprecated',
