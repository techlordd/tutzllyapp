...
-- Step 3: Convert BOOLEAN columns to TEXT (accept any CSV value)
...
-- Step 4: Convert DATE/TIME to TEXT to accept any CSV format
ALTER TABLE class_activities
...
-- Step 5: Drop old course_id FK and convert user_id FK to TEXT
