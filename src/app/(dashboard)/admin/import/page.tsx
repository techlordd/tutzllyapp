...
import { Upload, FileText, CheckCircle, XCircle, AlertCircle, ChevronDown } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="font-semibold text-gray-900 text-lg">Formidable Forms CSV Import</h2>
              <p className="text-sm text-gray-500 mt-1">
                Upload a CSV exported from Formidable Forms. Headers must match the original export format.
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
            ...
            {result.defaultPassword && result.inserted > 0 && (
              <div className="flex items-start gap-2 px-4 py-3 bg-blue-50 rounded-xl text-sm text-blue-700">
                ...
                <span>
                  Login accounts created for imported users with default password:{' '}
