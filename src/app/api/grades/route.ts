...
export async function GET(request: NextRequest) {
  try {
    ...
    let sql = `SELECT * FROM grade_book WHERE entry_status != 'deleted'`;
    const params: string[] = [];
...
export async function POST(request: NextRequest) {
  try {
    ...
    const grade = await queryOne(
      `INSERT INTO grade_book (tutor_id, tutor_name, student_id, student_name, course_name, course_id,
      ...
      [d.tutor_id,d.tutor_name,d.student_id,d.student_name,d.course_name,d.course_id,
