...
export async function POST(request: NextRequest) {
  try {
    ...
    const assignment = await queryOne(
      `INSERT INTO tutor_course_assignments (tutor_assign_id, tutor_id, tutor_username, tutor_sex, tutor_email, course_id, course_name, course_code, entry_status)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8,'active') RETURNING *`,
      [assignId, data.tutor_id, data.tutor_username, data.tutor_sex, data.tutor_email, data.course_id, data.course_name, data.course_code]
    );
